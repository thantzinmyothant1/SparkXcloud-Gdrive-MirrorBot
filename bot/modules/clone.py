...
def cloneNode(update, context):
    ...
    if is_gdtot:
        try:
            msg = sendMessage(f"𝐏𝐫𝐨𝐜𝐞𝐬𝐬𝐢𝐧𝐠: <code>{link}</code>", context.bot, update.message)
            link = gdtot(link)
    ...
    if is_gdrive_link(link):
        ...
        if files <= 20:
            msg = sendMessage(f"𝐂𝐥𝐨𝐧𝐢𝐧𝐠: <code>{link}</code>", context.bot, update.message)
        ...
        sendMessage('𝐒𝐞𝐧𝐝 𝐆𝐝𝐫𝐢𝐯𝐞 𝐨𝐫 𝐠𝐝𝐭𝐨𝐭 𝐥𝐢𝐧𝐤 𝐚𝐥𝐨𝐧𝐠 𝐰𝐢𝐭𝐡 𝐜𝐨𝐦𝐦𝐚𝐧𝐝 𝐨𝐫 𝐛𝐲 𝐫𝐞𝐩𝐥𝐲𝐢𝐧𝐠 𝐭𝐨 𝐭𝐡𝐞 𝐥𝐢𝐧𝐤 𝐛𝐲 𝐜𝐨𝐦𝐦𝐚𝐧𝐝', context.bot, update.message)
