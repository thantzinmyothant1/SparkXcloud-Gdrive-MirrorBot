...
from bot import bot, app, IMAGE_URL, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, IS_VPS, PORT, alive, web, OWNER_ID, AUTHORIZED_CHATS, LOGGER, Interval, rss_session, a2c
...
help = telegraph.create_page(
        title='SparkXcloud-Gdrive-MirrorBot',
