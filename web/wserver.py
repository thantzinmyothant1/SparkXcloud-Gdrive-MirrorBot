...
@app.route('/')
def homepage():
    return "<h1>See SparkXcloud-Gdrive-MirrorBot <a href='https://www.github.com/Spark-X-Cloud/SparkXcloud-Gdrive-MirrorBot'>@GitHub</a> By <a href='https://github.com/harshhaareddy'>Harshhaa</a></h1>"
