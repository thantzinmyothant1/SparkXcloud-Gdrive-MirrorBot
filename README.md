...
- Clone this repo:
```
git clone https://github.com/harshhaareddy/SparkXcloud-Gdrive-MirrorBot/
cd mirrorbot
```
...
**NOTE**: If you want to use port other than 80, change it in [docker-compose.yml](https://github.com/harshhaareddy/SparkXcloud-Gdrive-MirrorBot/blob/majorupdate/docker-compose.yml) also.
...
<p><a href="https://github.com/harshhaareddy/SparkXcloud-Gdrive-MirrorBot/blob/majorupdate/heroku-guide.md"> <img src="https://img.shields.io/badge/Deploy%20Guide-blueviolet?style=for-the-badge&logo=heroku" width="180""/></a></p>
